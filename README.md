...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,985 | 🐛 169 | 🌐 TypeScript | 📅 2026-09-11 - Cross-browser web automation platform for Node.js.
  * [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,011 | 🐛 3 | 🌐 Python | 📅 2026-09-11 - Drop-in Playwright wrapper that launches a stealth-patched Firefox 150 binary instead of vanilla Firefox.
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,577 | 🐛 257 | 🌐 TypeScript | 📅 2026-09-09 - High level API in Node.js to control Chrome.
...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 114,257 | 🐛 406 | 🌐 Python | 📅 2026-09-10 - Python library and service to automate browsing using AI agents and Chrome DevTools Protocol.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,022 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-11 - Provides browser automation capabilities using [Playwright](https://github.com/microsoft/playwright) ⭐ 95,985 | 🐛 169 | 🌐 TypeScript | 📅 2026-09-11
* [Skyvern](https://github.com/Skyvern-AI/Skyvern) ⭐ 22,975 | 🐛 235 | 🌐 Python | 📅 2026-09-11 - Use prompts + AI to automate actions in the browser.
* [CamoFox Browser](https://github.com/jo-inc/camofox-browser) ⭐ 10,939 | 🐛 56 | 🌐 JavaScript | 📅 2026-09-10 - Stealth headless browser for AI agents built on a Firefox fork with C++ fingerprint spoofing to bypass Cloudflare, Akamai, and bot detection.
* [Openwork](https://github.com/accomplish-ai/openwork) ⭐ 10,906 | 🐛 13 | 📅 2026-08-13 - MIT-licensed, open alternative to Anthropic's Cowork. Supports multiple LLM providers for launching computer-use agents to automate browser workflows.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,625 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-03 - Open-source browser sandbox and API for AI agents with session-backed automation, screenshots, PDFs, and anti-bot tooling.
* [Webcmd](https://github.com/agentrhq/webcmd) ⭐ 1,601 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-11 - CLI that learns a site's navigation once and compiles it into reusable deterministic commands for AI agents.
* [Libretto](https://github.com/saffron-health/libretto) ⭐ 890 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-21 - Open-source Playwright-based toolkit and CLI for coding agents to inspect pages, capture network traffic, record actions, and generate automation scripts.
...
* [Cheerio](https://github.com/cheeriojs/cheerio) ⭐ 30,484 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-11 - jQuery implementation in Node.js for DOM emulation.
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,678 | 🐛 408 | 🌐 JavaScript | 📅 2026-09-11 - DOM implementation in Node.js to emulate real browsers.
...
* [HeadlessBrowsers](https://github.com/dhamaniasad/HeadlessBrowsers) ⭐ 6,693 | 🐛 21 | 📅 2025-10-12 - Detailed list of multiple headless browsers.
