...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,494 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-24 - High level API in Node.js to control Chrome.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,068 | 🐛 167 | 🌐 TypeScript | 📅 2026-08-24 - Cross-browser web automation platform for Node.js.
...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 110,362 | 🐛 383 | 🌐 Python | 📅 2026-08-24 - Python library and service to automate browsing using AI agents and Chrome DevTools Protocol.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,426 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-21 - Provides browser automation capabilities using [Playwright](https://github.com/microsoft/playwright) ⭐ 95,068 | 🐛 167 | 🌐 TypeScript | 📅 2026-08-24
* [Skyvern](https://github.com/Skyvern-AI/Skyvern) ⭐ 22,843 | 🐛 217 | 🌐 Python | 📅 2026-08-24 - Use prompts + AI to automate actions in the browser.
* [Openwork](https://github.com/accomplish-ai/openwork) ⭐ 10,936 | 🐛 13 | 📅 2026-08-13 - MIT-licensed, open alternative to Anthropic's Cowork. Supports multiple LLM providers for launching computer-use agents to automate browser workflows.
* [CamoFox Browser](https://github.com/jo-inc/camofox-browser) ⭐ 8,848 | 🐛 64 | 🌐 JavaScript | 📅 2026-08-19 - Stealth headless browser for AI agents built on a Firefox fork with C++ fingerprint spoofing to bypass Cloudflare, Akamai, and bot detection.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,536 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-24 - Open-source browser sandbox and API for AI agents with session-backed automation, screenshots, PDFs, and anti-bot tooling.
...
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,659 | 🐛 410 | 🌐 JavaScript | 📅 2026-08-24 - DOM implementation in Node.js to emulate real browsers.
