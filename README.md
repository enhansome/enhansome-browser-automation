...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,527 | 🐛 267 | 🌐 TypeScript | 📅 2026-08-30 - High level API in Node.js to control Chrome.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,393 | 🐛 178 | 🌐 TypeScript | 📅 2026-08-30 - Cross-browser web automation platform for Node.js.
  * [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 1,953 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - Drop-in Playwright wrapper that launches a stealth-patched Firefox 150 binary instead of vanilla Firefox.
...
* [Chromedp](https://github.com/chromedp/chromedp) ⭐ 13,268 | 🐛 179 | 🌐 Go | 📅 2026-07-14 - Browser automation through Chrome DevTools Protocol fully implemented in Go.
...
* [CodeceptJS](https://github.com/Codeception/CodeceptJS) ⭐ 4,242 | 🐛 220 | 🌐 JavaScript | 📅 2026-08-30 - BDD style tests with support for multiple headless browsers.
...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 111,740 | 🐛 394 | 🌐 Python | 📅 2026-08-30 - Python library and service to automate browsing using AI agents and Chrome DevTools Protocol.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,636 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-28 - Provides browser automation capabilities using [Playwright](https://github.com/microsoft/playwright) ⭐ 95,393 | 🐛 178 | 🌐 TypeScript | 📅 2026-08-30
* [Skyvern](https://github.com/Skyvern-AI/Skyvern) ⭐ 22,885 | 🐛 223 | 🌐 Python | 📅 2026-08-31 - Use prompts + AI to automate actions in the browser.
* [Openwork](https://github.com/accomplish-ai/openwork) ⭐ 10,924 | 🐛 13 | 📅 2026-08-13 - MIT-licensed, open alternative to Anthropic's Cowork. Supports multiple LLM providers for launching computer-use agents to automate browser workflows.
* [CamoFox Browser](https://github.com/jo-inc/camofox-browser) ⭐ 8,986 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-25 - Stealth headless browser for AI agents built on a Firefox fork with C++ fingerprint spoofing to bypass Cloudflare, Akamai, and bot detection.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,566 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-25 - Open-source browser sandbox and API for AI agents with session-backed automation, screenshots, PDFs, and anti-bot tooling.
...
* [onUI](https://github.com/onllm-dev/onUI) ⭐ 98 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-28 - Browser extension and MCP server for annotation-first UI pair programming with AI agents.
...
* [Cheerio](https://github.com/cheeriojs/cheerio) ⭐ 30,473 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-28 - jQuery implementation in Node.js for DOM emulation.
...
* [Awesome Web Scraping](https://github.com/lorien/awesome-web-scraping) ⭐ 8,138 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-28 - Comprehensive list of tools, programming libraries and web services used in web scraping.
* [HeadlessBrowsers](https://github.com/dhamaniasad/HeadlessBrowsers) ⭐ 6,691 | 🐛 20 | 📅 2025-10-12 - Detailed list of multiple headless browsers.
