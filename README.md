...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,937 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-11 - Cross-browser web automation platform for Node.js.
  * [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,010 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Drop-in Playwright wrapper that launches a stealth-patched Firefox 150 binary instead of vanilla Firefox.
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,566 | 🐛 257 | 🌐 TypeScript | 📅 2026-09-09 - High level API in Node.js to control Chrome.
  * [Puppeteer-Extra](https://github.com/berstend/puppeteer-extra/tree/master/packages/puppeteer-extra) ⭐ 7,397 | 🐛 275 | 🌐 JavaScript | 📅 2024-07-18 - Plugin support for Puppeteer and several plugins including reCAPTCHA and adblocker.
...
* [Chromedp](https://github.com/chromedp/chromedp) ⭐ 13,274 | 🐛 180 | 🌐 Go | 📅 2026-07-14 - Browser automation through Chrome DevTools Protocol fully implemented in Go.
...
* [CodeceptJS](https://github.com/Codeception/CodeceptJS) ⭐ 4,241 | 🐛 209 | 🌐 JavaScript | 📅 2026-09-10 - BDD style tests with support for multiple headless browsers.
...
* [Selenium](https://www.seleniumhq.org) - Suite to automate multiple browsers in different platforms.
  * [PHP-Webdriver](https://github.com/php-webdriver/php-webdriver) ⭐ 5,200 | 🐛 32 | 🌐 PHP | 📅 2026-09-04 - PHP Client for Selenium/WebDriver.
...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 114,081 | 🐛 426 | 🌐 Python | 📅 2026-09-10 - Python library and service to automate browsing using AI agents and Chrome DevTools Protocol.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,986 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-09 - Provides browser automation capabilities using [Playwright](https://github.com/microsoft/playwright) ⭐ 95,937 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-11
* [Skyvern](https://github.com/Skyvern-AI/Skyvern) ⭐ 22,972 | 🐛 233 | 🌐 Python | 📅 2026-09-10 - Use prompts + AI to automate actions in the browser.
* [Openwork](https://github.com/accomplish-ai/openwork) ⭐ 10,908 | 🐛 13 | 📅 2026-08-13 - MIT-licensed, open alternative to Anthropic's Cowork. Supports multiple LLM providers for launching computer-use agents to automate browser workflows.
* [CamoFox Browser](https://github.com/jo-inc/camofox-browser) ⭐ 10,899 | 🐛 49 | 🌐 JavaScript | 📅 2026-09-10 - Stealth headless browser for AI agents built on a Firefox fork with C++ fingerprint spoofing to bypass Cloudflare, Akamai, and bot detection.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,617 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-03 - Open-source browser sandbox and API for AI agents with session-backed automation, screenshots, PDFs, and anti-bot tooling.
* [Webcmd](https://github.com/agentrhq/webcmd) ⭐ 1,594 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-10 - CLI that learns a site's navigation once and compiles it into reusable deterministic commands for AI agents.
* [Libretto](https://github.com/saffron-health/libretto) ⭐ 889 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-21 - Open-source Playwright-based toolkit and CLI for coding agents to inspect pages, capture network traffic, record actions, and generate automation scripts.
...
* [Cheerio](https://github.com/cheeriojs/cheerio) ⭐ 30,484 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-10 - jQuery implementation in Node.js for DOM emulation.
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,676 | 🐛 407 | 🌐 JavaScript | 📅 2026-09-10 - DOM implementation in Node.js to emulate real browsers.
...
* [X-Ray](https://github.com/matthewmueller/x-ray) ⭐ 5,908 | 🐛 74 | 🌐 JavaScript | 📅 2026-08-31 - Web Scraper with composable API and extra drivers.
...
* [Awesome Web Scraping](https://github.com/lorien/awesome-web-scraping) ⭐ 8,147 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-08 - Comprehensive list of tools, programming libraries and web services used in web scraping.
* [HeadlessBrowsers](https://github.com/dhamaniasad/HeadlessBrowsers) ⭐ 6,693 | 🐛 20 | 📅 2025-10-12 - Detailed list of multiple headless browsers.
* [Awesome Selenium](https://github.com/christian-bromann/awesome-selenium#readme) ⭐ 1,129 | 🐛 8 | 📅 2026-03-17 - Curated list of Selenium resources and related tools.
