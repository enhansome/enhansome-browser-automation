...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,464 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-16 - High level API in Node.js to control Chrome.
  * [Puppeteer-Extra](https://github.com/berstend/puppeteer-extra/tree/master/packages/puppeteer-extra) ⭐ 7,395 | 🐛 274 | 🌐 JavaScript | 📅 2024-07-18 - Plugin support for Puppeteer and several plugins including reCAPTCHA and adblocker.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,589 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-15 - Cross-browser web automation platform for Node.js.
  * [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 1,896 | 🐛 3 | 🌐 Python | 📅 2026-08-16 - Drop-in Playwright wrapper that launches a stealth-patched Firefox 150 binary instead of vanilla Firefox.
...
* [Chromedp](https://github.com/chromedp/chromedp) ⭐ 13,253 | 🐛 177 | 🌐 Go | 📅 2026-07-14 - Browser automation through Chrome DevTools Protocol fully implemented in Go.
...
* [CodeceptJS](https://github.com/Codeception/CodeceptJS) ⭐ 4,241 | 🐛 217 | 🌐 JavaScript | 📅 2026-08-15 - BDD style tests with support for multiple headless browsers.
...
* [Selenium](https://www.seleniumhq.org) - Suite to automate multiple browsers in different platforms.
  * [PHP-Webdriver](https://github.com/php-webdriver/php-webdriver) ⭐ 5,200 | 🐛 30 | 🌐 PHP | 📅 2026-08-14 - PHP Client for Selenium/WebDriver.
...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 109,427 | 🐛 355 | 🌐 Python | 📅 2026-08-16 - Python library and service to automate browsing using AI agents and Chrome DevTools Protocol.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,184 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-12 - Provides browser automation capabilities using [Playwright](https://github.com/microsoft/playwright) ⭐ 94,589 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-15
* [Skyvern](https://github.com/Skyvern-AI/Skyvern) ⭐ 22,761 | 🐛 215 | 🌐 Python | 📅 2026-08-16 - Use prompts + AI to automate actions in the browser.
* [Openwork](https://github.com/accomplish-ai/openwork) ⭐ 10,947 | 🐛 13 | 📅 2026-08-13 - MIT-licensed, open alternative to Anthropic's Cowork. Supports multiple LLM providers for launching computer-use agents to automate browser workflows.
* [CamoFox Browser](https://github.com/jo-inc/camofox-browser) ⭐ 8,634 | 🐛 85 | 🌐 JavaScript | 📅 2026-08-04 - Stealth headless browser for AI agents built on a Firefox fork with C++ fingerprint spoofing to bypass Cloudflare, Akamai, and bot detection.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,495 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-05 - Open-source browser sandbox and API for AI agents with session-backed automation, screenshots, PDFs, and anti-bot tooling.
* [Libretto](https://github.com/saffron-health/libretto) ⭐ 875 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-15 - Open-source Playwright-based toolkit and CLI for coding agents to inspect pages, capture network traffic, record actions, and generate automation scripts.
* [onUI](https://github.com/onllm-dev/onUI) ⭐ 93 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-28 - Browser extension and MCP server for annotation-first UI pair programming with AI agents.
...
* [Cheerio](https://github.com/cheeriojs/cheerio) ⭐ 30,455 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-14 - jQuery implementation in Node.js for DOM emulation.
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,651 | 🐛 407 | 🌐 JavaScript | 📅 2026-08-15 - DOM implementation in Node.js to emulate real browsers.
...
* [X-Ray](https://github.com/matthewmueller/x-ray) ⭐ 5,902 | 🐛 74 | 🌐 JavaScript | 📅 2026-08-02 - Web Scraper with composable API and extra drivers.
...
* [Awesome Web Scraping](https://github.com/lorien/awesome-web-scraping) ⭐ 8,114 | 🐛 3 | 🌐 Makefile | 📅 2026-07-28 - Comprehensive list of tools, programming libraries and web services used in web scraping.
...
* [Awesome Selenium](https://github.com/christian-bromann/awesome-selenium#readme) ⭐ 1,132 | 🐛 5 | 📅 2026-03-17 - Curated list of Selenium resources and related tools.
