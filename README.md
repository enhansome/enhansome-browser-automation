...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,492 | 🐛 262 | 🌐 TypeScript | 📅 2026-08-24 - High level API in Node.js to control Chrome.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,051 | 🐛 167 | 🌐 TypeScript | 📅 2026-08-24 - Cross-browser web automation platform for Node.js.
  * [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 1,928 | 🐛 4 | 🌐 Python | 📅 2026-08-23 - Drop-in Playwright wrapper that launches a stealth-patched Firefox 150 binary instead of vanilla Firefox.
...
* [CodeceptJS](https://github.com/Codeception/CodeceptJS) ⭐ 4,241 | 🐛 218 | 🌐 JavaScript | 📅 2026-08-24 - BDD style tests with support for multiple headless browsers.
...
* [Browser-Use](https://github.com/browser-use/browser-use) ⭐ 110,328 | 🐛 380 | 🌐 Python | 📅 2026-08-22 - Python library and service to automate browsing using AI agents and Chrome DevTools Protocol.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,422 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-21 - Provides browser automation capabilities using [Playwright](https://github.com/microsoft/playwright) ⭐ 95,051 | 🐛 167 | 🌐 TypeScript | 📅 2026-08-24
* [Skyvern](https://github.com/Skyvern-AI/Skyvern) ⭐ 22,842 | 🐛 218 | 🌐 Python | 📅 2026-08-24 - Use prompts + AI to automate actions in the browser.
* [Openwork](https://github.com/accomplish-ai/openwork) ⭐ 10,937 | 🐛 13 | 📅 2026-08-13 - MIT-licensed, open alternative to Anthropic's Cowork. Supports multiple LLM providers for launching computer-use agents to automate browser workflows.
* [CamoFox Browser](https://github.com/jo-inc/camofox-browser) ⭐ 8,836 | 🐛 63 | 🌐 JavaScript | 📅 2026-08-19 - Stealth headless browser for AI agents built on a Firefox fork with C++ fingerprint spoofing to bypass Cloudflare, Akamai, and bot detection.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,534 | 🐛 63 | 🌐 TypeScript | 📅 2026-08-19 - Open-source browser sandbox and API for AI agents with session-backed automation, screenshots, PDFs, and anti-bot tooling.
...
* [Cheerio](https://github.com/cheeriojs/cheerio) ⭐ 30,463 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-21 - jQuery implementation in Node.js for DOM emulation.
* [jsdom](https://github.com/jsdom/jsdom) ⭐ 21,659 | 🐛 408 | 🌐 JavaScript | 📅 2026-08-24 - DOM implementation in Node.js to emulate real browsers.
...
* [HeadlessBrowsers](https://github.com/dhamaniasad/HeadlessBrowsers) ⭐ 6,680 | 🐛 19 | 📅 2025-10-12 - Detailed list of multiple headless browsers.
